...
% sobrescreve). O nome do curso vai para a folha de rosto E para a capa (abaixo
% de "UNIVERSIDADE DO VALE DO ITAJAÍ", no lugar do bloco do PPGCA).
...
% Cabeçalho da instituição no TOPO DA CAPA — OPCIONAL: por padrão a capa já
% acompanha o \curso{} acima. Use apenas se quiser um cabeçalho diferente desse
% (ex.: incluir o Centro). Substitui o bloco todo, inclusive a universidade.
% Use \\ para quebrar linhas e DIGITE EM MAIÚSCULAS (aqui não há conversão
% automática de caixa).
