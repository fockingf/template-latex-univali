...
% precisar repetir o \nomenclature no preâmbulo. Nas menções seguintes, use só a
% sigla. Variações: \sigla*{}{} apenas cadastra (não escreve nada no texto) e
...
\sigla{IBGE}{Instituto Brasileiro de Geografia e Estatística}. Nas próximas
citações, basta escrever IBGE, sem repetir o nome completo.
